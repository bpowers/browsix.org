...
(function () {
    ...
    function getRedirectUrl() {
        ...
        // API.
        if (url.includes('://localhost') && url.endsWith('/')) url = url.slice(0, -1);
    ...
    function showPDF() {
        var retry = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 3;
    ...
    var sequence = ['pdflatex ' + TEX_FLAGS + '-draftmode ' + f, 'bibtex ' + f, 'pdflatex ' + TEX_FLAGS + f];

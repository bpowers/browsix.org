...
(function () {
    ...
    var fullSequence = ['pdflatex ' + TEX_FLAGS + '-draftmode ' + f, 'bibtex ' + f, 'pdflatex ' + TEX_FLAGS + '-draftmode ' + f, 'pdflatex ' + TEX_FLAGS + f];
    var sequence = ['pdflatex ' + TEX_FLAGS + '-draftmode ' + f];
    function runLatex() {
